...
"""This file contains the styling and methods to create the user-interface"""

# Styles and scripting for the page

main_page_head = ''' <!--Assigning HTML code to movie_title_content,
...
main_page_content = \
    ''' <!--Assigning HTML code to movie_title_content,
        to be used in Phython code -->
<!DOCTYPE html>
<html lang="en">
<body>
...
movie_tile_content = \
    ''' <!--Assigning HTML code to movie_title_content,
            to be used in Phython code -->
<div class="col-sm-2 col-md-4 col-lg-6 movie-tile text-center"data-trailer-you
tube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
   <img src="{poster_image_url}" width="220" height="342">
   <h3>{movie_title}</h3>
   <h6> {movie_story}</h6>
   <h6><b>Starring</b>: {movie_actors}</h6>
   <!--Comments:New added attribute Starring-->
   <h6><b>Release date</b>: {movie_release}</h6>
   <!--Comments:New added attribute Release date -->
   <button type="button" class="btn btn-warning">Rating:{movie_rating}</button>
   <!--Comments: Button created by calling
   class btn and btn-color from bootstrap-->
</div>
'''
