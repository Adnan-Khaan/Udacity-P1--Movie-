...
<head>
    ...
    <!-- Bootstrap 3 -->
    <link rel="stylesheet" href="https://netdna.bootstrapcdn.com/bootstrap/3.1.0/css/bootstrap.min.css"> <!--Link/path to Bootstarp-CSS code that is saved on Bootstrap cloud-->
...
main_page_content =''' <!--Assigning HTML code to movie_title_content, to be used in Phython code -->
<!DOCTYPE html>
<html lang="en">
  <body>
    <!-- Trailer Video Modal -->
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="#">Khan's Top Movies </a> <!-- Comment: To change the title of the page -->
          </div>
        </div>
      </div>
    </div>
...
<div class="col-sm-2 col-md-4 col-lg-6 movie-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
   ...
   <button type="button" class="btn btn-warning">Rating:{movie_rating}</button>   <!--Comments: Button created by calling class btn and btn-color from bootstrap-->
</div>
